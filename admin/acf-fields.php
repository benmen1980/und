...
if (function_exists('acf_add_local_field_group')) :
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                'key' => 'branch_pri_cst_nmber',
                'label' => __('Priority Customer Number', 'unidress'),
                'name' => 'branch_priority_cstmer_number',
                'type' => 'text',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                'key' => 'field_5cd6fd8d7a4ba',
                'label' => __('Number Of Days to Due Date', 'unidress'),
                'name' => 'no_of_days_to_due_date',
                'type' => 'number',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
            ...
            array(
                'key' => 'field_budget_by_points',
                'label' => __('Budget by points?', 'unidress'),
                'name' => 'budget_by_points',
                'type' => 'true_false',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
                ...
                'message' => __('Check this checkbox to set campagin as - Budget by points.', 'unidress'),
                'default_value' => 0,
                'ui' => 0,
                'ui_on_text' => '',
                'ui_off_text' => '',
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                'key' => 'field_price_include_vat',
                'label' => __('Manage prices include VAT', 'unidress'),
                'name' => 'price_list_include_vat',
                'type' => 'true_false',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
                ...
                'message' => __('Check this checkbox to show users products prices included VAT prices', 'unidress'),
                'default_value' => 0,
                'ui' => 0,
                'ui_on_text' => '',
                'ui_off_text' => '',
            ...
            array(
                ...
                'message' => __('Check this checkbox to Hide Phone on Checkout page', 'unidress'),
                'default_value' => 0,
                'ui' => 0,
                'ui_on_text' => '',
                'ui_off_text' => '',
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'label' => __('Select Single Branch', 'unidress'),
                'name' => 'user_branch',
                'type' => 'select',
                'instructions' => '',
                'required' => 0,
            ...
            array(
                'key' => 'field_600689fd97935',
                'label' => __('Select all Branches', 'unidress'),
                'name' => 'select_all_shipping_options',
                'type' => 'true_false',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
                ...
                'message' => __('Select all Branches', 'unidress'),
                'default_value' => 0,
                'ui' => 0,
                'ui_on_text' => '',
                'ui_off_text' => '',
            ...
            array(
                'key' => 'field_5fd9d7c5bb008',
                'instructions' => __('If you are working with Multiples Branches, select here...','unidress'),
                'label' => __('Select Multiples Branches','unidress'),
                'name' => 'user_branches',
                'type' => 'post_object',
                'required' => 0,
                'conditional_logic' => 0,
